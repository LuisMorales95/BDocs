...
import com.novanesttech.beedocs.utils.UserInfoPreference.PreferenceKey;
...
import static com.novanesttech.beedocs.BeeDocsApplication.getPreference;
...
public class SignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailEdit = (EditText) findViewById(R.id.SignIn_User);
        passwordEdit = (EditText) findViewById(R.id.SignIn_Contra);
        SignIn_LogIn = (ImageView) findViewById(R.id.SignIn_LogIn);

        if (getPreference().hasSignedAccount()) {
            emailEdit.setText(
                    getPreference().getString(PreferenceKey.email)
            );
            passwordEdit.setText(
                    getPreference().getString(PreferenceKey.password)
            );
        }

        SignIn_LogIn.setOnClickListener(v ->
                SignInRequest(
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                SignIn_LogIn.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v) {
                                                        SignInRequest(emailEdit.getText().toString(), passwordEdit.getText().toString());
                                                    }
                                                });
                                            }
                                        }).show();
