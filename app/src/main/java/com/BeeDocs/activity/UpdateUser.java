...
import static com.BeeDocs.utils.Constant.WS_UpdateAccount;
        ...
        Register_Registrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Register_Usuario.getText().toString().equals("")||Register_Contra.getText().toString().equals("")){
                    new AlertDFont.Builder(UpdateUser.this)
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (response.getString("Response").equals("Success")){
                                new AlertDFont.Builder(UpdateUser.this).setMessage("Actualizacion exitosa")
                                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                dialog.dismiss();
                                ...
                                new AlertDFont.Builder(UpdateUser.this).setMessage("Actualizacion Fallid, intente mas tarde")
                                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                dialog.dismiss();
